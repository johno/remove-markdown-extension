# remove-markdown-extension [![Build Status](https://secure.travis-ci.org/johnotander/remove-markdown-extension.png?branch=master)](https://travis-ci.org/johnotander/remove-markdown-extension)
